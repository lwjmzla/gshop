...
// // 6、用户名密码登陆
// export const getPwdLogin = ({name, pwd, captcha}) => ajax(BASE_URL+'/login_pwd', {name, pwd, captcha}, 'POST')
// // 7、发送短信验证码
// export const getSendCode = (phone) => ajax(BASE_URL+'/sendcode', {phone})
// // 8、手机号验证码登陆
// export const getSmsLogin = (phone, code) => ajax(BASE_URL+'/login_sms', {phone, code}, 'POST')
// // 9、根据会话获取用户信息
