  ...
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="supportShow = true">
      <div class="discounts-left">
        <div :class="`activity activity-${colorArr[info.supports[0].type]}`">
          <span class="content-tag">
    ...
    <div class="activity-sheet" v-show="supportShow">
      <div class="activity-sheet-content">
        ...
        <ul class="list" v-if="info.supports">
          <li :class="`activity-item activity-${colorArr[item.type]}`" v-for="(item,index) in info.supports" :key="index">
            <span class="content-tag">
