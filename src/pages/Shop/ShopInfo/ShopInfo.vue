<template>
  <div class="shop-info" ref="shopInfoWrap">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div :class="`activity-item activity-${colorArr[item.type]}`" v-for="(item,index) in info.supports" :key="index">
      ...
      <section class="section">
        ...
        <div class="pic-wrapper">
          <ul class="pic-list" style="width:624px;">
            <!-- 一般来说是JS算他的宽 -->
...
export default {
  ...
  mounted () {
    this.scroll = new BScroll(this.$refs.shopInfoWrap, {
      click: true
    })
